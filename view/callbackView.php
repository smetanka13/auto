...
<div class="main_cont_cnt content_cnt back">
	...
	<div class="container-fluid com_bt">
		<button data-toggle='modal' data-target='#callb_modal' class="btn confirm_but"><img src="images/icons/comment.svg">Оставить отзыв</button>
	</div>
